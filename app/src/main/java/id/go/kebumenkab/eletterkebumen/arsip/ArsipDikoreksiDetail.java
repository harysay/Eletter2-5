...
public class ArsipDikoreksiDetail extends AppBaseActivity implements View.OnClickListener, PenerimaAdapter.AdapterListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logger      = new Logger();
        notifikasiDialog = new NotifikasiDialog(getApplicationContext(), ArsipDikoreksiDetail.this);
        ...
        data            = (ArsipDikoreksiData) intent.getSerializableExtra("object");
        ...
        /**  **/
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                            ...
                            String strPesan = data.getMessage();

                            t_penerima.setText("Operator");
