...
public class ArsipDiajukanDetail extends AppBaseActivity implements View.OnClickListener, PenerimaAdapter.AdapterListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logger      = new Logger();
        notifikasiDialog = new NotifikasiDialog(getApplicationContext(), ArsipDiajukanDetail.this);
