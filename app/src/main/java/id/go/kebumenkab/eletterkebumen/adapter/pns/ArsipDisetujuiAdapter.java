...
public class ArsipDisetujuiAdapter extends RecyclerView.Adapter<ArsipDisetujuiAdapter.MyViewHolder>
    ...
    private List<ArsipDisetujuiData> messages;
    private List<ArsipDisetujuiData> messagesMaster;
    private List<ArsipDisetujuiData> messagesFiltered;
        ...
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    ...
                    List<ArsipDisetujuiData> filteredList = new ArrayList<>();


                    for (ArsipDisetujuiData row : messagesMaster) {
            ...
            protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
                messages = (ArrayList<ArsipDisetujuiData>) filterResults.values;
    ...
    public ArsipDisetujuiAdapter(Context mContext, List<ArsipDisetujuiData> messages, MessageAdapterListener listener) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ArsipDisetujuiData message = messages.get(position);
    ...
    private void applyProfilePicture(MyViewHolder holder, ArsipDisetujuiData message) {
