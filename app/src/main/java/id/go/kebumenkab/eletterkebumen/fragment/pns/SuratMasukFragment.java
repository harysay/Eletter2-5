...
public class SuratMasukFragment extends Fragment implements
    ...
    public boolean inisiasiSudah = false;
    ...
    public boolean fragmentBolehDiperbarui(){
        inisiasiSudah = true;
        return inisiasiSudah;
    }
                            ...
                            if (result.getStatus().equals(Tag.TAG_STATUS_SUKSES)) {
                                ...
                                if (todos.size() == 0) {
                                    tampilError(true, 5,"");
                                        ...
                                        if(strJabatan.equalsIgnoreCase("")){
    ...
    public void onStop() {
        ...
        logger.d("onStop","SuratMasukFragment | allowUpdateUI "+ allowUpdateUI);
    }
    ...
    public void onDestroyView() {
        super.onDestroyView();
        allowUpdateUI = false;
        logger.d("onDestroyView","SuratMasukFragment | allowUpdateUI "+ allowUpdateUI);
    ...
    public void onDestroy() {
        super.onDestroy();
        allowUpdateUI =false;
        logger.d("onDestroy","SuratMasukFragment | allowUpdateUI "+ allowUpdateUI);
    ...
    class Task implements Runnable {
        ...
        public void run() {
            if(allowUpdateUI) {
                getActivity().runOnUiThread(() -> getInbox());
