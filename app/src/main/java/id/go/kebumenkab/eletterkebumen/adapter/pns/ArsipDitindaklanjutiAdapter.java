...
public class ArsipDitindaklanjutiAdapter extends RecyclerView.Adapter<ArsipDitindaklanjutiAdapter.MyViewHolder>
    implements Filterable {
    private Context mContext;
    private List<ArsipDitindaklanjutiData> messages;
    private List<ArsipDitindaklanjutiData> messagesMaster;
    private List<ArsipDitindaklanjutiData> messagesFiltered;
        ...
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    ...
                    List<ArsipDitindaklanjutiData> filteredList = new ArrayList<>();


                    for (ArsipDitindaklanjutiData row : messagesMaster) {
            ...
            protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
                messages = (ArrayList<ArsipDitindaklanjutiData>) filterResults.values;
    ...
    public ArsipDitindaklanjutiAdapter(Context mContext, List<ArsipDitindaklanjutiData> messages, MessageAdapterListener listener) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ArsipDitindaklanjutiData message = messages.get(position);
    ...
    private void applyProfilePicture(MyViewHolder holder, ArsipDitindaklanjutiData message) {
