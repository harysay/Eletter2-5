...
public class ArsipDisposisiAdapter extends RecyclerView.Adapter<ArsipDisposisiAdapter.MyViewHolder>
    ...
    public ArsipDisposisiAdapter(Context mContext, List<ArsipDisposisiData> messages, MessageAdapterListener listener) {
