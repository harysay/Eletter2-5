...
public class PemberitahuanFragment extends Fragment implements
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        allowUpdateUI = true;
        logger.d("onCreateView","PemberitahuanFragment | allowUpdateUI "+ allowUpdateUI);
    ...
    public void onMessageRowClicked(int position) {
        ...
        // if enabled, change the row state to activated
            ...
            if(jenis.equalsIgnoreCase("pengembalian")){
                ...
                alertBuilder.setPositiveButton("Lihat", (dialogInterface, i) -> {
                    Intent intentDetail1 = new Intent(PemberitahuanFragment.this.getContext(), WebViewActivity.class);

                    intentDetail1.putExtra(TAG_ID_SURAT, pemberitahuan.getIdSurat());
                    intentDetail1.putExtra(TAG_ID_PEMBERITAHUAN, pemberitahuan.getIdPemberitahuan());
                    intentDetail1.putExtra(TAG_JENISSURAT, TAG_PEMBERITAHUAN);
                    intentDetail1.putExtra(TAG_ALUR_SURAT, TAG_PENGEMBALIAN);

                    getActivity().startActivity(intentDetail1);
                });
                ...
                alertBuilder.setMessage(pemberitahuan.getPesan());
                alertBuilder.setPositiveButton("Lihat", (dialogInterface, i) -> {
                    Intent intentDetail12 = new Intent(PemberitahuanFragment.this.getContext(), WebViewActivity.class);

                    intentDetail12.putExtra(TAG_ID_SURAT, pemberitahuan.getIdSurat());
                    intentDetail12.putExtra(TAG_ID_PEMBERITAHUAN, pemberitahuan.getIdPemberitahuan());
                    intentDetail12.putExtra(TAG_JENISSURAT, TAG_PEMBERITAHUAN);
                    intentDetail12.putExtra(TAG_ALUR_SURAT, jenis);
                    intentDetail12.putExtra("arsip", isArsip);

                    getActivity().startActivity(intentDetail12);
                });
                AlertDialog dialog = alertBuilder.create();
                dialog.show();
                ...
                alertBuilder.setMessage(pemberitahuan.getPesan());
                alertBuilder.setPositiveButton("Lihat", (dialogInterface, i) -> {
                    Intent intentDetail13 = new Intent(PemberitahuanFragment.this.getContext(), WebViewActivity.class);

                    intentDetail13.putExtra(TAG_ID_SURAT, pemberitahuan.getIdSurat());
                    intentDetail13.putExtra(TAG_ID_PEMBERITAHUAN, pemberitahuan.getIdPemberitahuan());
                    intentDetail13.putExtra(TAG_JENISSURAT, TAG_PEMBERITAHUAN);

                    intentDetail13.putExtra(TAG_ALUR_SURAT, Tag.TAG_KOREKSI);
                    intentDetail13.putExtra("arsip", isArsip);

                    getActivity().startActivity(intentDetail13);
                });
                AlertDialog dialog = alertBuilder.create();
                dialog.show();
                            ...
                            if (result.getStatus().equalsIgnoreCase(Tag.TAG_STATUS_SUKSES)) {
                                ...
                                if (todos.size() == 0) {
                                    ...
                                    for (Pemberitahuan pemberitahuan : todos) {
                                        ...
                                        logger.d("Respon", pemberitahuan.getNamaPelaksana());
                                    ...
                                    if(strJabatan.equals("")){
                                       // Dashboard.setBadge(1, String.valueOf(todos.size()));
                                        Dashboard.setBadge(1, " ");
                                    }else {
                                        if(cekPenandaTangan()){
                                            // Dashboard.setBadge(2, String.valueOf(todos.size()));
                                            Dashboard.setBadge(2, " ");
                                        }else{
                                            // Dashboard.setBadge(2, String.valueOf(todos.size()));
                                            Dashboard.setBadge(2, " ");
                                        }
...
//                Log.e("Error eletter", t.getLocalizedMessage());
    ...
    public void onResume() {
        ...
        logger.d("OnResume","PemberitahuanFragment | allowUpdateUI "+ allowUpdateUI);
    ...
    public void onPause() {
        ...
        logger.d("onPause","PemberitahuanFragment | allowUpdateUI "+ allowUpdateUI);
    ...
    public void onStop() {
        ...
        logger.d("onStop","PemberitahuanFragment | allowUpdateUI "+ allowUpdateUI);
    ...
    public void onDestroyView() {
        super.onDestroyView();
        allowUpdateUI = false;
        logger.d("onDestroyView","PemberitahuanFragment | allowUpdateUI "+ allowUpdateUI);
    ...
    public void onDestroy() {
        super.onDestroy();
        allowUpdateUI =false;
        logger.d("onDestroy","PemberitahuanFragment | allowUpdateUI "+ allowUpdateUI);
