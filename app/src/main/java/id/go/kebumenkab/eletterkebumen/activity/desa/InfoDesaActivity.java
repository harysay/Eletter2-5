...
import id.go.kebumenkab.eletterkebumen.activity.AppCompatPreferenceActivity;
import id.go.kebumenkab.eletterkebumen.activity.LoginActivity;
import id.go.kebumenkab.eletterkebumen.activity.ProfilActivity;
import id.go.kebumenkab.eletterkebumen.activity.WebActivity;
import id.go.kebumenkab.eletterkebumen.helper.PrefManager;
import id.go.kebumenkab.eletterkebumen.intro.WelcomeActivity;


public class InfoDesaActivity extends AppCompatPreferenceActivity {
    private static final String TAG;



    static {
        TAG = InfoDesaActivity.class.getSimpleName();
    }
    ...
    public static class MainPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(final Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
            addPreferencesFromResource(R.xml.preferences_desa);
            ...
            // open Ubah Password preference click listener
            Preference prefUbahPassword = findPreference(getString(R.string.title_gantipassword));
            prefUbahPassword.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                public boolean onPreferenceClick(Preference preference) {
                    openUbahPassword(getActivity());
                    return true;
                }
            });
...
//        context.startActivity(Intent.createChooser(intent, context.getString(R.string.choose_email_client)));
    ...
    public static void openUbahPassword(Context context){
        Intent intent = new Intent(context, GantiPassword.class);
        context.startActivity(intent);
    }
