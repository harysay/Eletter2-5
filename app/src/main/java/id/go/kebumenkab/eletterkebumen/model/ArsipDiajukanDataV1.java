...
public class ArsipDiajukanDataV1 implements Serializable {
    ...
    @Expose
    private PenerimaKonsep penerima;
    ...
    public PenerimaKonsep getPenerima() {
        return penerima;
    }

    public void setPenerima(PenerimaKonsep penerima) {
