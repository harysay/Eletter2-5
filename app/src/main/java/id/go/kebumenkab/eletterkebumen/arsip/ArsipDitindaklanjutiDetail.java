...
public class ArsipDitindaklanjutiDetail extends AppBaseActivity implements View.OnClickListener{
    ...
    private TextView t_nomor,  t_deskripsi;
    ...
    ArsipDitindaklanjutiData data;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_detail_arsiplain);
        ...
        logger      = new Logger();
        notifikasiDialog = new NotifikasiDialog(getApplicationContext(), ArsipDitindaklanjutiDetail.this);
        ...
        data              = (ArsipDitindaklanjutiData) intent.getSerializableExtra("object");
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                            ...
                            if(data.getLampiran().length()>0){
                                strLampiran = data.getLampiran().toString();
