...
public class ArsipDikoreksiAdapter extends RecyclerView.Adapter<ArsipDikoreksiAdapter.MyViewHolder>
    implements Filterable {
    private Context mContext;
    private List<ArsipDikoreksiData> messages;
    private List<ArsipDikoreksiData> messagesMaster;
    private List<ArsipDikoreksiData> messagesFiltered;
        ...
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    ...
                    List<ArsipDikoreksiData> filteredList = new ArrayList<>();


                    for (ArsipDikoreksiData row : messagesMaster) {
            ...
            protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
                messages = (ArrayList<ArsipDikoreksiData>) filterResults.values;
    ...
    public ArsipDikoreksiAdapter(Context mContext, List<ArsipDikoreksiData> messages, MessageAdapterListener listener) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ArsipDikoreksiData message = messages.get(position);
