...
import id.go.kebumenkab.eletterkebumen.adapter.pns.ArsipDitelaahAdapter;
...
public class ArsipDitelaahActivity extends AppCompatActivity  implements
        SwipeRefreshLayout.OnRefreshListener, ArsipDitelaahAdapter.MessageAdapterListener{

    private List<ArsipDiajukanData> arsips = new ArrayList<>();
    private RecyclerView recyclerView;
    public ArsipDitelaahAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logger = new Logger();
        notifikasiDialog = new NotifikasiDialog(getApplicationContext(), ArsipDitelaahActivity.this);
        ...
        mAdapter = new ArsipDitelaahAdapter(getApplicationContext(), arsips,
                ArsipDitelaahActivity.this);
    ...
    private void getData() {
        ...
        Call<ResultArsipDiajukan> call = apiService.getArsipDitelaahLengkap(token,String.valueOf(currentPage));
    ...
    private void getDataNext(int page) {
        ...
        Call<ResultArsipDiajukan> call = apiService.getArsipDitelaahLengkap(token, String.valueOf(page));
    ...
    public void onMessageRowClicked(int position) {
        ...
        if (mAdapter.getSelectedItemCount() > 0) {
            ...
            Intent intentDetail = new Intent(getApplicationContext(), ArsipDitelaahDetail.class);
