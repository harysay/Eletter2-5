...
public class ArsipLainAdapter extends RecyclerView.Adapter<ArsipLainAdapter.MyViewHolder>
    implements Filterable {
    private Context mContext;
    private List<ArsipLainData> messages;
    private List<ArsipLainData> messagesMaster;
    private List<ArsipLainData> messagesFiltered;
        ...
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    ...
                    List<ArsipLainData> filteredList = new ArrayList<>();


                    for (ArsipLainData row : messagesMaster) {
            ...
            protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
                messages = (ArrayList<ArsipLainData>) filterResults.values;
    ...
    public ArsipLainAdapter(Context mContext, List<ArsipLainData> messages, MessageAdapterListener listener) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ArsipLainData message = messages.get(position);
    ...
    private void applyProfilePicture(MyViewHolder holder, ArsipLainData message) {
